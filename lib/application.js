...
var STATE_INITED  = 1,  // app has inited
    ...
    STATE_STOPPED  = 4;  // app has stoped
...
Application.load = function(name, component, opts) {
  if (!name)
    throw Error('Name was not defined in call to app.load(...)');
  ...
  console.log('Attempting to load: ', name, component, opts);
 ...
 */
 Application.start = function(cb) {
  console.log('Starting Pomelo App...')
